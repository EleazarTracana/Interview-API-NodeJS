...
module.exports = {
    ...
    userExist:   new message(true, "403", 'el usuario no pudo darse de alta, ya existe'),
    ...
    addUser:   new message(false,"200", 'usuario dado de alta exitosamente'),
    candidateDelete:  new message(false,"200","Se ha eliminado correctamente el candidato"),
